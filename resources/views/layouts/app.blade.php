                        ...
                        @else
                              ...
                              <li class="nav-item" title="Home">
                                  <a href="{{ route('carts') }}" class="nav-link">
                                    <i class="fa-solid fa-cart-arrow-down text-dark nav-icon"></i>
                                </a>
                              </li>

                              {{-- create item --}}
                              <li class="nav-item" title="Create Item">
                    ...
                    @if (request()->is('admin/*'))
                        <div class="col-3">
                            <div class="list-group">
                                ...
                                <a href="{{ route('admin.item') }}" class="list-group-item {{ request()->is('admin/posts') ? 'active': '' }}">
                                    <i class="fa-solid fa-newspaper"></i>items
                                </a>
                            </div>
                        </div>
                    @endif
